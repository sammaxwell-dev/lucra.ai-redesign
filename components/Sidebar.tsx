    ...
    <>
        ...
        {(!isCollapsed || mobile) && (
          <div className="flex items-center gap-2">
            ...
            {mobile ? (
              ...
              <button onClick={onToggle} className="p-2 text-slate-400 hover:text-slate-600 hover:bg-slate-50 rounded-lg transition-colors">
                <PanelLeft size={20} />
              </button>
            )}
          </div>
        ...
        <div className="mb-8">
          ...
          <nav className="space-y-0.5">
            <button
              ...
              className={`w-full flex items-center ${isCollapsed && !mobile ? 'justify-center' : 'gap-3'} px-3 py-2.5 rounded-xl text-sm font-medium transition-colors ${currentView === ViewState.HOME ? 'bg-[#e4ecf5] text-slate-900' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-700'}`}
              title="Dashboard"
            >
              <LayoutGrid size={18} />
            ...
            <button
              ...
              className={`w-full flex items-center ${isCollapsed && !mobile ? 'justify-center' : 'gap-3'} px-3 py-2.5 rounded-xl text-sm font-medium transition-colors ${currentView === ViewState.CHATS ? 'bg-[#e4ecf5] text-slate-900' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-700'}`}
              title="Chats"
            >
            ...
            <button
              ...
              className={`w-full flex items-center ${isCollapsed && !mobile ? 'justify-center' : 'gap-3'} px-3 py-2.5 rounded-xl text-sm font-medium transition-colors ${currentView === ViewState.FILES ? 'bg-[#e4ecf5] text-slate-900' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-700'}`}
              title="Files"
            >
              <FolderOpen size={18} />
            ...
            <button
              className={`w-full flex items-center ${isCollapsed && !mobile ? 'justify-center' : 'gap-3'} px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500 hover:bg-slate-50 hover:text-slate-700 transition-colors`}
              title="Settings"
            >
              <Settings size={18} />
        ...
        {(!isCollapsed || mobile) && (
          <div className="mb-6">
            ...
            <div className="space-y-0.5">
              ...
              <button className="group w-full flex items-center gap-3 px-3 py-2 rounded-lg text-left text-slate-600 hover:text-slate-900 text-sm hover:bg-slate-50 transition-colors">
              ...
              <button className="group w-full flex items-center gap-3 px-3 py-2 rounded-lg text-left text-slate-600 hover:text-slate-900 text-sm hover:bg-slate-50 transition-colors">
                <MessageSquareText size={16} className="shrink-0 text-slate-400" />
                <span className="flex-1 truncate">Moms (VAT) Rules 2024</span>
                <MoreHorizontal size={14} className="opacity-0 group-hover:opacity-100 text-slate-400 transition-opacity" />
              </button>
              <button className="group w-full flex items-center gap-3 px-3 py-2 rounded-lg text-left text-slate-600 hover:text-slate-900 text-sm hover:bg-slate-50 transition-colors">
                <MessageSquareText size={16} className="shrink-0 text-slate-400" />
                <span className="flex-1 truncate">Aktiebolag vs Enskild</span>
                <MoreHorizontal size={14} className="opacity-0 group-hover:opacity-100 text-slate-400 transition-opacity" />
              </button>
              <button className="group w-full flex items-center gap-3 px-3 py-2 rounded-lg text-left text-slate-600 hover:text-slate-900 text-sm hover:bg-slate-50 transition-colors">
                <MessageSquareText size={16} className="shrink-0 text-slate-400" />
                <span className="flex-1 truncate">K10 Form Calculation</span>
                <MoreHorizontal size={14} className="opacity-0 group-hover:opacity-100 text-slate-400 transition-opacity" />
              </button>
            </div>
          </div>
      ...
      <div className="p-4 border-t border-slate-100">
        ...
        {isCollapsed && !mobile && (
          <button
            onClick={onToggle}
            className="w-full mt-2 p-2 text-slate-400 hover:text-slate-600 hover:bg-slate-50 rounded-lg transition-colors flex items-center justify-center"
          >
